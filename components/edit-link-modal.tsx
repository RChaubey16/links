        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!noExpiry && (
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    max={365}
                    placeholder="days"
                    className="w-20 px-2.5 py-1.5 rounded-lg border border-slate-200 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500 transition"
                  />
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-4 py-2.5 bg-sky-600 text-white text-sm font-medium rounded-lg hover:bg-sky-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
